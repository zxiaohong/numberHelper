...
$(function () {
	...
	$(".active_btn").click(function () {
		var params = {
			message: 'Only $0.99,Do you want to unlock it?',
		...
		if (returnValue === 0) {//"确定"
			...
			BS.b$.IAP.enableIAP({
				...
				cb: "BS.b$.cb_handleIAPCallback"
			});
			BS.b$.IAP.getPrice(b$.App.getAppId() + ".plugin.DateTime.Format");
			BS.b$.IAP.getUseableProductCount(b$.App.getAppId() + ".plugin.DateTime.Format");
			b$.IAP.buyProduct({productIdentifier: b$.App.getAppId() + ".plugin.DateTime.Format", quantity: 1});
		} else {
			return;
		}
	});
